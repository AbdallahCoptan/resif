            ...
            for d in dirs:
                ...
                if not os.path.islink(dirpath):
                    try:
                        ...
                        click.secho("Failed to change permissions of directory %s" % dirpath, err=True, fg='yellow')
            for f in files:
                ...
                if not os.path.islink(filepath):
                    try:
                        ...
                        click.secho("Failed to change permissions of file %s" % filepath, err=True, fg='yellow')
    except KeyError:
